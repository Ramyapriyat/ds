...
c = np.arange(1, 20, 3)
c1d = np.arange(1,40,3)
d1d = np.arange(0,100,5)
print (d1d)
print (c1d)
print(c)
...
# The slice notation specifies a start and end value, 
# and copies the list from start up to but not including the end (end-exclusive). 
# 
# The syntax is:
# 
...
# and if no value is passed to step, it is assumed `step = 1`.
# 
# Note you can use slice notation with multi-dimensional indexing, as in `a[0:2, :5]`.
# This is the extent of indexing you'll need for this course but feel free to check out [the official NumPy documentation]
# (https://numpy.org/doc/stable/user/basics.indexing.html) 
# for extensive documentation on more advanced NumPy array indexing techniques.
...
sliced_two_dim_rows = two_dim[0:3]
